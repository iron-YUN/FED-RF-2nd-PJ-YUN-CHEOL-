...
const headphones = [
  ...
  },
  {
    ...
    spec2: [
      ...
      "Yes",
      "Carry, Storage",
      `7.68" H x 6.18" W x 3.15" D (0.520 lb)`,
      "Metal, Plastic, Leather (Protein)",
      "Leather (Hard)",
      "Protein Leather",
      "Yes",
      "24 hours",
  ...
  },
  {
    ...
    spec2: [
      ...
      "No",
      `8.27" H x 6.69" W x 3.15" D (1.96 lb)`,
  ...
  },
  {
    ...
    spec2: [
      ...
      "Noise Cancelling",
      "No",
      `8.43" H x 6.34" W x 3.15" D (1.99 lb)`,
...
const earbuds = [
  {
    ...
    spec2: [
      ...
      "IPX4",
      "Charging",
      `1.23" H x 0.79" W x 0.96" D (0.017 lb)`,
      `2.61" H x 2.34" W x 1.05" D (0.132 lb)`,
      ...
      "Yes",
      "USB C PORT",
      "A2DP Bluetooth Audio Streaming, HFP Bluetooth",
      "5.3",
      "30'",
      "Bose Music App",
    ],
  },
  {
    ...
    spec2: [
      ...
      "IPX4",
      "Charging, Protection",
      `0.73" H x 0.67" W x 1.07" D (0.0140 lb)`,
      `1.65" H x 2.56" W x 1.04" D (0.0966 lb)`,
      "Plastic (PC-ABS), Metal, Silicone, Gold Plating",
      "Plastic (Hard)",
      "Yes",
      "7.5 hours",
      "1 hour",
...
const speakers = [
  {
    ...
    spec2: [
      "No Microphone",
      "Stereo, SimpleSync, Full Range Speakers",
      "No",
      "IP67",
      `4.73" H x 10.42" W x 4.13" D (4.900 lb)`,
      "Aluminum, Fabric, Nylon, Plastic, Silicone, Steel",
      "20 hours",
      "5 hours",
      "USB-C In/Out",
      "5.4",
  ...
  },
  {
    ...
    spec2: [
      ...
      "No",
      "IP67",
      `3.56" H x 7.93" W x 2.06" D (1.300 lb)`,
      "Aluminum, Fabric, Nylon, Plastic, Silicone, Steel",
      "12 hours",
      "4 hours",
      "USB C PORT",
  ...
  },
  {
    ...
    spec2: [
      ...
      "Speakerphone",
      "No",
      `2" H x 7.06" W x 2.31" D (1.44 lb)`,
      "Aluminum, Plastic, Steel, Metal, Silicone",
      "12 hours",
      "USB C PORT",
      "Bluetooth, Wireless Connectivity",
      "3",
  ...
  },
  {
    ...
    spec2: [
      ...
      "No",
      "IP67",
      `3.87" H x 3.87" W x 1.37" D (0.68 lb)`,
      "Metal, Plastic, Silicone, Steel",
      "6 hours",
      "USB MICRO PORT",
  ...
  },
  {
    ...
    spec2: [
      "Built-in Microphone",
      "Multiroom, SimpleSync",
      "No",
      "IPX4",
      `7.54" H x 4.69" W x 4.09" D (2.34 lb)`,
  ...
  },
  {
    ...
    spec2: [
      ...
      "No",
      "IP55",
      `7.25" H x 4.13" W x 4.13" D (2 lb)`,
      "Aluminum, Plastic, Silicone, Metal, Fabric",
      "17 hours",
      "USB MICRO B PORT",
  ...
  },
  {
    ...
    spec2: [
      ...
      "No",
      "IP55",
      `5.97" H x 3.24" W x 3.24" D (1.46 lb)`,
      "Aluminum, Plastic, Silicone",
      "13 hours",
      "USB MICRO B PORT",
      "Bluetooth, NFC Connectivity, Wireless Connectivity",
      "4.2",
  ...
  },
  {
    ...
    spec2: ["Stereo", "No", "17.031 lb", "Metal, Plastic"],
  },
  {
    idx: "8",
    ...
    spec2: [
      "8 Microphones, Built-in Microphone",
      "Multiroom, SimpleSync",
      "No",
      `8" H x 6.7" W x 4.3" D (4.75 lb)`,
...
const homeTheater = [
  ...
  },
  {
    ...
    spec2: [
      ...
      `2.21" H x 23.38" W x 4.02" D (4.34 lb)`,
      `4.1" H x 1.6" W x 0.5" D (0.07 lb)`,
      "Metal, Plastic",
      "Bluetooth",
      "4.2",
      "Up to 30 ft (9 m)",
  ...
  },
  {
    ...
    spec2: [
      "Auto On, Auto Standby, Buttons, In App Control, In App Volume Control, Pairing, Bass",
      `12.9" H x 11.6" W x 11.6" D (30 lb)`,
      "Plastic, Glass",
      "Wireless Connectivity",
    ],
  },
...
const paSystems = [
  {
    ...
    spec2: [
      ...
      "Yes",
      `13.10" H x 9.40" W x 11.00" D (14.40 lb)`,
  ...
  },
  {
    ...
    spec2: [
      "No",
      `79.21" H x 13.98" W x 17.95" D (52 lb)`,
      "Bluetooth",
      "Bose Music App",
    ],
  },
  {
    ...
    spec2: [
      "No",
      `78.94" H x 12.52" W x 17.32" D (38 lb)`,
      "Bluetooth",
      "Bose Music App",
    ],
  },
  {
    ...
    spec1: ["Sound Options", "Audio cable included", "Entire Product System"],
    spec2: ["Audiences up to 1000, Audiences up to 500", "No", "68.3 lb"],
  },
  {
    idx: "4",
    ...
    spec2: ["No", `20.87" H x 9.84" W x 20.87" D (36 lb)`, "Wood"],
  },
  {
    idx: "5",
    ...
    spec2: ["No", `27.17" H x 12.01" W x 21.65" D (52.15 lb)`, "Wood"],
  },
  {
    idx: "6",
    name: "F1 Subwoofer",
    ...
    spec1: ["Sound Options", "Audio cable included", "Entire Product System"],
    spec2: ["Audiences up to 1000", "No", "69.3 lb"],
  },
  {
    idx: "7",
    ...
    spec1: ["Audio cable included", "Entire Product System"],
    spec2: ["No", "3.153 lb"],
  },
  {
    idx: "8",
